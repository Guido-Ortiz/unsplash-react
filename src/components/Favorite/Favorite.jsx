...
import { addPhoto, editPhoto, removePhoto } from '../../redux/actions/actions';
import { Card, CardHeader, CardMedia, CardContent, CardActions, IconButton, Chip, Stack, Tooltip, Modal, Box, Typography, TextField } from '@mui/material';
  ...
  const handleClose = () => setOpen(false);
    ...
    return (
        ...
        <Box sx={style}>
          ...
          <TextField variant='outlined' label='description' value={description} />
        </Box>
      </Modal>
        </div>
    );
